"""
LightGBM model implementation following Strategy Pattern
"""
...
class LightGBMModel(BaseModel):
    ...
    def __init__(self, model_path: str):
        ...
        """
        super().__init__(model_name="LightGBM", model_path=model_path)

    def load_model(self) -> bool:
        """
        Load LightGBM pipeline from pickle file
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        if self.is_loaded:
            try:
                ...
                # Get LightGBM-specific parameters if available
                lgbm_model = self.model.named_steps.get("model")
                if lgbm_model:
                    info["hyperparameters"] = {
                        "n_estimators": getattr(lgbm_model, "n_estimators", None),
                        "learning_rate": getattr(lgbm_model, "learning_rate", None),
                        "num_leaves": getattr(lgbm_model, "num_leaves", None),
                    }
            except Exception as e:
